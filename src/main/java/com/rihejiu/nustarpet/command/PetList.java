...
public class PetList {
    ...
    public void zhanma(Player player) {
        // 创建一个新的物品，这里使用钻石剑作为示例
        ItemStack customItem = new ItemStack(Material.MONSTER_EGG);
        // 获取 ItemMeta，用于设置 Lore 和 NBT
        ItemMeta meta = customItem.getItemMeta();
        ...
        // 创建 Lore 列表并添加 Lore 行
        List<String> lore = new ArrayList<>();
        lore.add(Utils.msgColor("&61级战马"));
        lore.add(Utils.msgColor("&8&m一一一一一一一一一一一一一一一一一"));
        lore.add(Utils.msgColor("&7需求等级: 35"));
        lore.add(Utils.msgColor("&8&m一一一一一一一一一一一一一一一一一"));
        lore.add(Utils.msgColor("&7经验: 0(0%)"));
        lore.add(Utils.msgColor("&8&m一一一一一一一一一一一一一一一一一"));
        lore.add(Utils.msgColor("&6力量: 60" + "+" + pet.getTalentPowerNum() + "[" + pet.getTalentPower()+ "]" ));
        lore.add(Utils.msgColor("&6敏捷: 55" + "+" + pet.getTalentSpeedNum() + "[" + pet.getTalentSpeed() + "]" ));
        lore.add(Utils.msgColor("&6体力: 60" + "+" + pet.getTalentSpiritNum() + "[" + pet.getTalentSpirit() + "]" ));
        lore.add(Utils.msgColor("&6智慧: 55" + "+" + pet.getTalentWisdomNum() + "[" + pet.getTalentWisdom() + "]" ));
        lore.add(Utils.msgColor("&8&m一一一一一一一一一一一一一一一一一"));
        lore.add(Utils.msgColor("&d果实: 0(上限: 1)"));
        lore.add(Utils.msgColor("&8&m一一一一一一一一一一一一一一一一一"));
        lore.add(Utils.msgColor("&c异兽生命值: 20/") + pet.getMaxHealth());
        lore.add(Utils.msgColor("&8&m一一一一一一一一一一一一一一一一一"));
        lore.add(Utils.msgColor("&7一只被封印着的白色战马，可以将它召唤"));
        lore.add(Utils.msgColor("&7出来为你战斗。"));
        lore.add(Utils.msgColor("&7种族天赋:"));
        lore.add(Utils.msgColor("&7[高级寒冰][高级吸血][铁皮][撕裂]"));
        lore.add(Utils.msgColor("&8&m一一一一一一一一一一一一一一一一一"));
        lore.add(Utils.msgColor("&3携带天赋: "));
        lore.add(Utils.msgColor("&3" + ZhanMa.generateRandomString()));
        lore.add(Utils.msgColor("&8&m一一一一一一一一一一一一一一一一一"));
        lore.add(Utils.msgColor("&4血脉: 未开启"));
        lore.add(Utils.msgColor("&8&m一一一一一一一一一一一一一一一一一"));
        lore.add(Utils.msgColor("&7售价: 10000"));
        meta.setLore(lore);
        meta.setDisplayName(ChatColor.WHITE+ "战马");
        customItem.setItemMeta(meta);
        // 设置NBT标签
        customItem = NBTUtils.setStringTag(customItem, "力量", pet.getTalentPower());
        customItem = NBTUtils.setStringTag(customItem, "体力", pet.getTalentSpirit());
        ...
        customItem = NBTUtils.setStringTag(customItem, "MaxLevel", "90");
        customItem = NBTUtils.setStringTag(customItem, "Player", player.getName());
        customItem = NBTUtils.setStringTag(customItem, "PetId", "战马");
        customItem = NBTUtils.setNBTTag(customItem, "EntityTag", "id","minecraft:skeleton_horse");
        // 给玩家物品
        player.getInventory().addItem(customItem);
    }
}
